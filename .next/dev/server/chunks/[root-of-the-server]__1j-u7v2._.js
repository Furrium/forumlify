...
async function GET(req) {
    ...
    try {
        ...
        const superR = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`SELECT id FROM users WHERE role = 'admin' ORDER BY created_at ASC, id ASC LIMIT 1`);
        ...
        const r = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(query, params);
        // 标记超级管理员（前端显示"超级管理员"）
        const rows = r.rows.map((u)=>({
                ...u,
                is_super: u.id === superAdminId
            }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1j-u7v2._.js.map