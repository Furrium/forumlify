...
async function GET(req) {
    try {
        const r = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT * FROM friendly_links ORDER BY sort_order');
...
async function POST(req) {
    ...
    try {
        const r = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO friendly_links (title, url)
       VALUES ($1, $2)
       RETURNING *`, [
            title,
            url
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1778uys._.js.map