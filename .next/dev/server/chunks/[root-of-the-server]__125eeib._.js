...
async function POST(req) {
    ...
    try {
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT id FROM reports WHERE post_id = $1 AND reporter_id = $2 AND status = $3', [
            post_id,
            user.id,
            'pending'
        ]);
        if (existing.rows.length > 0) {
            return Response.json({
                error: '你已经举报过此帖子，请等待处理'
            }, {
                status: 400
            });
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO reports (post_id, reporter_id, reason)
       VALUES ($1, $2, $3)`, [
            post_id,
            user.id,
            reason
...
//# sourceMappingURL=%5Broot-of-the-server%5D__125eeib._.js.map