...
async function GET(req) {
    ...
    try {
        const r = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT id, username, avatar_url, bio, signature, role, created_at FROM users WHERE id = $1', [
            user.id
        ]);
        if (!r.rows[0]) {
            return Response.json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1yb_nu7._.js.map