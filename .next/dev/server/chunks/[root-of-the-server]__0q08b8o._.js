...
"[project]/app/api/admin/custom-pages/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        const r = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT id, name, title, content, enabled, created_at, updated_at FROM custom_pages ORDER BY created_at');
...
async function POST(req) {
    ...
    if (!/^[a-zA-Z0-9\-_]+$/.test(name)) {
        return Response.json({
            error: '页面名称只允许字母、数字、短横线和下划线'
        }, {
            status: 400
        });
    }
    try {
        const r = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO custom_pages (name, title, content)
       VALUES ($1, $2, $3)
       RETURNING *`, [
            name,
            title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0q08b8o._.js.map