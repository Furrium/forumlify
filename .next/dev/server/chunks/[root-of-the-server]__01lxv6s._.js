...
"[project]/app/api/users/profile/[username]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    try {
        const r = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT id, username, avatar_url, bio, role, signature, created_at FROM users WHERE username = $1', [
            username
        ]);
        if (r.rows.length === 0) {
            return Response.json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__01lxv6s._.js.map