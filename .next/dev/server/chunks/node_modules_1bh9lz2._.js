module.exports = [
"[project]/node_modules/aws4fetch/dist/aws4fetch.esm.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AwsClient {
    ...
    async sign(input, init) {
        ...
        const signer = new AwsV4Signer(Object.assign({
            url: input.toString()
        ...
        try {
            ...
            if (e instanceof TypeError) {
                return new Request(signed.url.toString(), Object.assign({
                    duplex: 'half'
                }, signed));
            }
            throw e;
...
class AwsV4Signer {
    constructor({ method, url, headers, body, accessKeyId, secretAccessKey, sessionToken, service, region, cache, datetime, signQuery, appendSessionToken, allHeaders, singleEncode }){
        ...
        this.signableHeaders = [
            'host',
            ...this.headers.keys()
        ].filter((header)=>allHeaders || !UNSIGNABLE_HEADERS.has(header)).sort();
...
"[project]/node_modules/next/dist/esm/build/templates/app-route.js { INNER_APP_ROUTE => \"[project]/app/api/uploads/[name]/route.js [app-route] (ecmascript)\" } [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$app$2d$route$2f$module$2e$compiled$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppRouteRouteModule"]({
    definition: {
        ...
        page: "/api/uploads/[name]/route",
        pathname: "/api/uploads/[name]",
        filename: "route",
        bundlePath: ""
    },
    distDir: ("TURBOPACK compile-time value", ".next/dev") || '',
    relativeProjectDir: ("TURBOPACK compile-time value", "") || '',
    resolvedPagePath: "[project]/app/api/uploads/[name]/route.js",
    nextConfigOutput,
    ...
    userland: ()=>__turbopack_context__.r("[project]/app/api/uploads/[name]/route.js [app-route] (ecmascript)"),
    ...
    ...("TURBOPACK compile-time truthy", 1) ? {
        getUserland: ()=>__turbopack_context__.r("[project]/app/api/uploads/[name]/route.js [app-route] (ecmascript)")
...
async function handler(req, res, ctx) {
    ...
    let srcPage = "/api/uploads/[name]/route";
...
//# sourceMappingURL=node_modules_1bh9lz2._.js.map