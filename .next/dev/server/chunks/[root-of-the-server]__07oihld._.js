...
async function GET(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO settings (key, value) VALUES ('forum_name', 'Forumlify')
       ON CONFLICT (key) DO NOTHING`);
        const r = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT key, value FROM settings ORDER BY key');
        const settings = {};
        r.rows.forEach((row)=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$http$2d$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["jsonWithEtag"])(req, settings);
    } catch  {
...
async function PUT(req) {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(`INSERT INTO settings (key, value) VALUES ($1, $2)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07oihld._.js.map